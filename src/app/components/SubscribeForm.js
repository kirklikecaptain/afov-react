...
const SubscribeForm = () => {
  const postUrl = 'https://afistfulofvinyl.us20.list-manage.com/subscribe/post?u=93e673352c70e1d2b7101564e&amp;id=2b5005c4f0';
  return (
    <MailchimpSubscribe
      url={postUrl}
...
const CustomForm = ({ status, message, onValidated }) => {
  ...
  return (
    <StyledSignupForm>
      ...
      <div className='button-box'>{status !== 'success' && <button onClick={submit}>Subscribe</button>}</div>
    </StyledSignupForm>
  );
};
