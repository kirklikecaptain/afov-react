...
const StyledHero = styled.div`
	...
	.text-content {
		...
		.badge {
			...
			margin-bottom: 5px;
			background: ${props => props.heroVideo.fields.artist.fields.color ? darken(.3, props.heroVideo.fields.artist.fields.color) : darken(.3, "#333")};
			color: white;
			border-radius: 3px;
			box-shadow: 1px 3px 5px rgba(0,0,0,.1);
			@media (min-width: 600px) {
		...
		.artist {
			font-size: 2.3rem;
			color: ${props => props.heroVideo.fields.artist.fields.color ? lighten(.4, props.heroVideo.fields.artist.fields.color) : lighten(.3, "#333")};
		}
	}
	.overlay {
		background: ${props => props.heroVideo.fields.artist.fields.color ? props.heroVideo.fields.artist.fields.color : "#333"};
