      ...
      <Fade ssrReveal duration={700}>
        <div className='image'>
          ...
          <Fade ssrReveal right duration={700} delay={300} distance='100px'>
            <Link className='mobile-button' id='hero-button-mobile' to={`/${props.heroVideo.fields.artist.fields.slug}/${props.heroVideo.fields.slug}`}>
              <MdPlayArrow />
            </Link>
          </Fade>
        </div>
...
const StyledHero = styled.div`
  ...
  .full-button {
    ...
    @media (min-width: 600px) {
      ...
      &:hover {
        ...
        background: ${props => (props.heroVideo.fields.artist.fields.color ? lighten(0.4, props.heroVideo.fields.artist.fields.color) : '#333')};
        box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.1);
        .icon {
          color: ${props => (props.heroVideo.fields.artist.fields.color ? darken(0.3, props.heroVideo.fields.artist.fields.color) : '#333')};
        }
      }
      .icon {
  ...
  .text-content {
    ...
    .badge {
      ...
      margin-bottom: 5px;
      background: ${props => (props.heroVideo.fields.artist.fields.color ? darken(0.3, props.heroVideo.fields.artist.fields.color) : darken(0.3, '#333'))};
      color: white;
      border-radius: 3px;
      box-shadow: 1px 3px 5px rgba(0, 0, 0, 0.1);
      @media (min-width: 600px) {
    ...
    .artist {
      font-size: 2.3rem;
      color: ${props => (props.heroVideo.fields.artist.fields.color ? lighten(0.4, props.heroVideo.fields.artist.fields.color) : lighten(0.3, '#333'))};
    }
  }
  .overlay {
    background: ${props => (props.heroVideo.fields.artist.fields.color ? props.heroVideo.fields.artist.fields.color : '#333')};
